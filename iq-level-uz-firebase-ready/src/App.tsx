...
export default function App() {
  ...
  const handleDuelFinish = (
    ...
    // Real duel result written to the shared cloud feed (also bumps the
    // real global duel counter).
    cloud.recordDuel(newOutcome).catch(() => {});
  };
          ...
          <AnimatePresence mode="wait">
            ...
            {currentTab === 'leaderboard' && (
              <motion.div
                ...
                transition={{ duration: 0.22, ease: 'easeOut' }}
              >
                <LeaderboardModule currentUser={userProfile} />
              </motion.div>
            )}
